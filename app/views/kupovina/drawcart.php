...
<table class="table table-bordered table-striped table-hover" style="margin-top:20px;">
    ...
    <tr>
        ...
        <td style="padding-top:25px;width: 5%; text-align: center;"><i class="fa fa-trash-o fa-2x rem-from-shc"></i></td>
    </tr>
    <?php }?>
...
<div class="row">
    <div class="col-lg-12">
        <button class="btn btn-success btn-lg pull-right" style="margin-left:20px;">POTVRDITE NARUDZBINU</button>
